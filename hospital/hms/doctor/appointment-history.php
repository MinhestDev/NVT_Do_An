...
{ ?>
	...
	<a href="appointment-history.php?id=<?php echo $row['id']?>&cancel=update" onClick="return confirm('Bạn có chắc chắn muốn hủy cuộc hẹn này?')"class="btn btn-transparent btn-xs tooltips" title="Hủy cuộc hẹn" tooltip-placement="top" tooltip="Remove">Hủy</a>
	<?php } else {
