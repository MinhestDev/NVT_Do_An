...
if(isset($_POST['submit']))
  {
   ...
   $pres=$_POST['pres'];
    ...
    if ($query) {
    echo '<script>alert("Lịch sử thuốc đã được thêm vào.")</script>';
    echo "<script>window.location.href ='manage-patient.php'</script>";
  }
  else
    {
      echo '<script>alert("Hãy thử lại!")</script>';
    }
...
<td colspan="4" style="font-size:20px;color:blue">
 Chi tiết bệnh nhân</td></tr>
  ...
  <tr>
    <th scope>Số điện thoại bệnh nhân</th>
  ...
  <tr>
    ...
    <th>Bệnh sử của bệnh nhân (nếu có)</th>
    <td><?php  echo $row['PatientMedhis'];?></td>
     <th>Ngày bệnh nhân đăng ký</th>
...
<p align="center">
 <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal">Thêm bệnh</button></p>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
     <div class="modal-content">
      <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Thêm lịch sử bệnh</h5>
  ...
  <tr>
    ...
    <th>Đơn thuốc :</th>
    <td>
    <textarea name="pres" placeholder="Đơn thuốc" rows="12" cols="14" class="form-control wd-450" required="true"></textarea></td>
  </tr>
