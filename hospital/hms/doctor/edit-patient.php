...
if($sql)
{
echo "<script>alert('Thông tin bệnh nhân cập nhật thành công!');</script>";
...
<textarea type="text" name="medhis" class="form-control"  placeholder="Nhập bệnh sử của bệnh nhân (nếu có)" required="true"><?php  echo $row['PatientMedhis'];?></textarea>
</div>
<div class="form-group">
<label for="fess">
 Ngày tạo
