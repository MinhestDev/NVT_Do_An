...
<input type="email" id="patemail" name="patemail" class="form-control"  placeholder="Nhập email bệnh nhân" required="true" onBlur="userAvailability()">
...
<textarea type="text" name="medhis" class="form-control"  placeholder="Nhập bệnh sử của bệnh nhân (nếu có)" required="true"></textarea>
</div>
