...
<html lang="en">
	<head>
		<title>Admin | Nhật ký phiên bác sĩ</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin  | Nhật ký phiên bác sĩ</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin </span>
									...
									<li class="active">
										<span>Nhật ký phiên bác sĩ</span>
									</li>
								</ol>
							</div>
						</section>
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												<th class="center">#</th>
												<th class="hidden-xs">ID người dùng</th>
												<th>Tên đăng nhập</th>
												<th>IP người dùng</th>
