								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Quản lý người dùng</h2>
...
{
?>
											Tổng số người dùng :<?php echo htmlentities($num_rows);  } ?>
												</a>
											</p>
										</div>
									</div>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle"> Các cuộc hẹn</h2>
			...
			<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle"> Truy vấn mới</h2>
...
?>
											Tổng số truy vấn mới: <?php echo htmlentities($num_rows22);   ?>
												</a>
												</a>
											</p>
										</div>
