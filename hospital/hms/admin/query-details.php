...
if($query){
echo "<script>alert('Đã cập nhật thành công nhận xét của quản trị viên.');</script>";
...
<html lang="en">
	<head>
		<title>Admin | Chi tiết truy vấn</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Chi tiết truy vấn</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
