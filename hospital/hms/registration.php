...
if($query)
{
	echo "<script>alert('Đăng ký thành công, bạn có thể đăng nhập.');</script>";
	...
	<body class="login">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2>HMS | Đăng ký bệnh nhân</h2></a>
				</div>
				<!-- start: REGISTER BOX -->
				<div class="box-register">
					<form name="registration" id="registration"  method="post" onSubmit="return valid();">
						<fieldset>
							...
							<p>
								Nhập thông tin cá nhân của bạn vào bên dưới:
							</p>
