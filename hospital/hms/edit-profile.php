...
<html lang="en">
	<head>
		<title>Người dùng | Sửa thông tin</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Người dùng | Sửa thông tin</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Sửa thông tin</h5>
												</div>
...
{
?>
<h4><?php echo htmlentities($data['fullName']);?>'s Thông tin</h4>
<p><b>Ngày đăng ký: </b><?php echo htmlentities($data['regDate']);?></p>
<?php if($data['updationDate']){?>
<p><b>Ngày sửa gần nhất: </b><?php echo htmlentities($data['updationDate']);?></p>
<?php } ?>
...
<div class="form-group">
					...
					<a href="change-emaild.php">Cập nhật email của bạn</a>
														</div>
