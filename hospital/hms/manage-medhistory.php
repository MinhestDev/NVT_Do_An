...
<html lang="en">
	<head>
		<title>Người dùng đăng ký | Xem lịch sử bệnh</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Người dùng | Xem lịch sử bệnh</h1>
</div>
<ol class="breadcrumb">
<li>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">Xem <span class="text-bold">lịch sử bệnh</span></h5>
